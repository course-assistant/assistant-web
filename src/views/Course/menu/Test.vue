...
<!--                <img style="margin-left: 350px;" height="12px" src="@/assets/img/目录.svg" alt="">-->
    ...
    <span class="dialog-footer">
      ...
      <el-button type="primary" @click="toAddTest">确 定</el-button>
              ...
              <el-card class="box-card" shadow="hover" style="margin-top: 20px;width: 100%">
                ...
                <div style="width: 100%;">
                  ...
                  <el-checkbox v-model="checked" style="position: absolute;top: 0px;left: 20px"/>
                    ...
                    <div style="position: absolute;top: 0px;left: 60px;width: 100%;">
                      ...
                      <div style="position: absolute;top:0px;right: 150px;color:#409eff;">
                        <span>
                          发布
                        </span>
                      </div>

                      <div style="position: absolute;top:0px;right: 80px;color:#409eff;">
                        <span>
                          查看
                        </span>
                      </div>
                      ...
                      <div style="padding-top: 40px">
                        ...
                        <span style="padding-left: 20px;color: #999999">创建于1分钟前</span>
                      </div>
                  ...
                  <el-table
                    ...
                    <el-table-column type="expand">
                      <template #default="props">
                        ...
                        <div v-if="props.row.problem.type===1" style="position: relative">
                          <span style="position: absolute;right: 250px;top: 0">正确答案: A</span>
                          <p style="font-size: 16px;margin-bottom: 10px">人声的主要作用有(  )</p>
                        ...
                        <div v-if="props.row.problem.type===2" style="position: relative">
                          <span style="position: absolute;right: 250px;top: 0">正确答案: A</span>
                          <p style="font-size: 16px;margin-bottom: 10px">人声的没有作用</p>
                          <p class="optionStyle">A. 对</p>
                          <p class="optionStyle">B. 错</p>

                        </div>

                        <div v-if="props.row.problem.type===3" style="position: relative">
                          <span style="position: absolute;right: 250px;top: 0">正确答案:
                            <span style="color:red;margin-left: 20px;">刻画人物形象</span>
                          </span>
                          <p style="font-size: 16px;margin-bottom: 10px">人声的有___的作用 </p>
