    ...
    <div class="round-div">
      ...
      <div class="nav">
        ...
        <el-breadcrumb class="f-size" separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item
            :to="'/course/' + $route.params.course_id + '/week-mission/week-mission-list/' + $route.params.week_id + '/'">
            第01周
          </el-breadcrumb-item>
          <el-breadcrumb-item>
            任务01
      ...
      <div class="week-mission-detail">
        <div class="week-mission">
          ...
          <div class="main-content">
            <div class="title">
              ...
              <div style="margin-bottom: 30px">
                ...
                <div style="float: right">
                  <el-button v-show="!isShow" size="mini" @click="add_main_content" type="primary">添加</el-button>
                  <el-button v-show="isShow" size="mini" @click="edit_main_content" type="primary">编辑</el-button>
                </div>
            ...
            <p class="content" v-show="isShow" v-html="convertHtml(main_content)"></p>
            <el-input
              v-show="!isShow"
              type="textarea"
              :rows="5"
          ...
          <div class="main-goal">
            <div class="title">
              ...
              <div>
                <b> 主要目标</b>
                <div style="float: right">
                  <el-button size="mini" @click="add_goal" type="primary">添加</el-button>
                </div>
              </div>
            ...
            <div class="goal">
              ...
              >
                ...
                <!--                <el-input>{{ goal.goal_name }}</el-input>-->
